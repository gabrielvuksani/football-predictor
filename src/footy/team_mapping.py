...
TEAM_MAPPINGS: Dict[str, list[str]] = {
    ...
    "sporting-lisbon": ["Sporting CP", "Sporting", "Sporting Lisbon", "Sporting Clube de Portugal"],
    "braga": ["Braga", "SC Braga", "Sporting Braga"],
    "vitoria-guimaraes": ["Vitória SC", "Vitória Guimarães", "Guimaraes"],
    "boavista": ["Boavista", "Boavista FC"],
    "famalicao": ["Famalicão", "FC Famalicão"],
    ...
    "estoril": ["Estoril", "Estoril Praia", "GD Estoril Praia"],
    "vizela": ["Vizela", "FC Vizela"],
    "estrela-amadora": ["Estrela Amadora", "CF Estrela da Amadora"],
    "nacional": ["Nacional", "CD Nacional"],
    "aves": ["Aves", "CD Aves"],

    # ======================== TURKEY ========================
    "galatasaray": ["Galatasaray", "Galatasaray SK"],
    "fenerbahce": ["Fenerbahçe", "Fenerbahce", "Fenerbahçe SK"],
    "besiktas": ["Beşiktaş", "Besiktas", "Beşiktaş JK"],
    "trabzonspor": ["Trabzonspor"],
    "basaksehir": ["Başakşehir", "Istanbul Basaksehir", "İstanbul Başakşehir"],
    ...
    "standard-liege": ["Standard Liège", "Standard Liege", "Standard"],
    "gent": ["Gent", "KAA Gent"],
    "antwerp": ["Antwerp", "Royal Antwerp FC"],
    "union-saint-gilloise": ["Union SG", "Union Saint-Gilloise", "Royale Union Saint-Gilloise"],
    "mechelen": ["Mechelen", "KV Mechelen"],
    "cercle-brugge": ["Cercle Brugge", "Cercle Brugge KSV"],
    "charleroi": ["Charleroi", "Royal Charleroi SC"],
    "st-truiden": ["Sint-Truiden", "St. Truiden", "STVV"],
    "oh-leuven": ["OH Leuven", "Oud-Heverlee Leuven"],
    "westerlo": ["Westerlo", "KVC Westerlo"],
    "kortrijk": ["Kortrijk", "KV Kortrijk"],
    "eupen": ["Eupen", "KAS Eupen"],
    ...
    "hibernian": ["Hibernian", "Hibernian FC", "Hibs"],
    ...
    "livingston": ["Livingston", "Livingston FC"],

    # ======================== AUSTRIA ========================
    "red-bull-salzburg": ["Red Bull Salzburg", "FC Red Bull Salzburg", "RB Salzburg", "Salzburg"],
    "rapid-wien": ["Rapid Wien", "SK Rapid Wien", "Rapid Vienna"],
    "sturm-graz": ["Sturm Graz", "SK Sturm Graz"],
    "lask": ["LASK", "LASK Linz"],
    "austria-wien": ["Austria Wien", "FK Austria Wien", "Austria Vienna"],
    "wolfsberg": ["Wolfsberger AC", "Wolfsberg", "WAC"],
    "hartberg": ["Hartberg", "TSV Hartberg"],
    "rheindorf-altach": ["Rheindorf Altach", "SCR Altach", "Altach"],
    "austria-klagenfurt": ["Austria Klagenfurt", "SK Austria Klagenfurt"],
    "blau-weiss-linz": ["Blau-Weiß Linz", "BW Linz"],
    "tirol": ["WSG Tirol", "WSG Swarovski Tirol"],
    "ried": ["Ried", "SV Ried"],

    # ======================== GREECE ========================
    "olympiacos": ["Olympiacos", "Olympiacos FC", "Olympiakos"],
    "panathinaikos": ["Panathinaikos", "Panathinaikos FC"],
    "aek-athens": ["AEK Athens", "AEK Athens FC"],
    "paok": ["PAOK", "PAOK FC", "PAOK Thessaloniki"],
    "aris-thessaloniki": ["Aris", "Aris Thessaloniki"],
    "volos": ["Volos NFC", "Volos"],
    "ofi-crete": ["OFI Crete", "OFI"],
    "asteras-tripolis": ["Asteras Tripolis"],
    "ionikos": ["Ionikos", "Ionikos Nikeas"],
    "lamia": ["Lamia", "PAS Lamia"],
    "atromitos": ["Atromitos", "Atromitos FC"],
    ...
    "basel": ["Basel", "FC Basel", "FC Basel 1893"],
    "zurich": ["Zürich", "FC Zürich", "FC Zurich"],
    "lugano": ["Lugano", "FC Lugano"],
    "servette": ["Servette", "Servette FC"],
    "st-gallen": ["St. Gallen", "FC St. Gallen"],
    "sion": ["Sion", "FC Sion"],
    "lucerne": ["Luzern", "FC Luzern", "Lucerne"],
    "grasshoppers": ["Grasshoppers", "Grasshopper Club Zürich"],
    "winterthur": ["Winterthur", "FC Winterthur"],
    "yverdon": ["Yverdon", "Yverdon Sport FC"],
    "lausanne": ["Lausanne-Sport", "FC Lausanne-Sport", "Lausanne"],

    # ======================== DENMARK ========================
    "copenhagen": ["Copenhagen", "FC Copenhagen", "FC København"],
    "midtjylland": ["Midtjylland", "FC Midtjylland"],
    "brondby": ["Brøndby", "Brondby IF", "Brøndby IF"],
    "nordsjaelland": ["Nordsjælland", "FC Nordsjælland", "Nordsjaelland"],
    "aab": ["AaB", "Aalborg BK"],
    "aarhus": ["AGF", "Aarhus GF", "AGF Aarhus"],
    "silkeborg": ["Silkeborg", "Silkeborg IF"],
    "randers": ["Randers", "Randers FC"],
    "viborg": ["Viborg", "Viborg FF"],
    "lyngby": ["Lyngby", "Lyngby BK"],
    "odense": ["OB", "Odense BK", "Odense"],
    "vejle": ["Vejle", "Vejle BK"],

    # ======================== SWEDEN ========================
    "malmo-ff": ["Malmö FF", "Malmo FF", "Malmö"],
    "aik": ["AIK", "AIK Stockholm"],
    "djurgarden": ["Djurgården", "Djurgårdens IF", "Djurgarden"],
    "hammarby": ["Hammarby", "Hammarby IF"],
    "hacken": ["Häcken", "BK Häcken", "Hacken"],
    "norrkoping": ["Norrköping", "IFK Norrköping", "Norrkoping"],
    "elfsborg": ["Elfsborg", "IF Elfsborg"],
    "goteborg": ["IFK Göteborg", "IFK Gothenburg", "Goteborg"],
    "kalmar": ["Kalmar", "Kalmar FF"],
    "sirius": ["IK Sirius", "Sirius"],
    "varberg": ["Varberg", "Varbergs BoIS"],
    "mjallby": ["Mjällby", "Mjällby AIF", "Mjallby"],
    "halmstad": ["Halmstad", "Halmstads BK"],
    "brommapojkarna": ["BP", "IF Brommapojkarna", "Brommapojkarna"],
    "varnamo": ["Värnamo", "IFK Värnamo", "Varnamo"],
    "sundsvall": ["Sundsvall", "GIF Sundsvall"],

    # ======================== NORWAY ========================
    "bodo-glimt": ["Bodø/Glimt", "Bodo/Glimt", "FK Bodø/Glimt"],
    "molde": ["Molde", "Molde FK"],
    "rosenborg": ["Rosenborg", "Rosenborg BK"],
    "brann": ["Brann", "SK Brann"],
    "viking": ["Viking", "Viking FK"],
    "lillestrom": ["Lillestrøm", "Lillestrom", "Lillestrøm SK"],
    "tromso": ["Tromsø", "Tromso", "Tromsø IL"],
    "valerenga": ["Vålerenga", "Valerenga", "Vålerenga IF"],
    "haugesund": ["Haugesund", "FK Haugesund"],
    "odd": ["Odd", "Odds BK"],
    "sarpsborg": ["Sarpsborg 08", "Sarpsborg", "Sarpsborg 08 FF"],
    "kristiansund": ["Kristiansund", "Kristiansund BK"],
    "sandefjord": ["Sandefjord", "Sandefjord Fotball"],
    "ham-kam": ["HamKam", "Ham-Kam", "Hamarkameratene"],
    "stromsgodset": ["Strømsgodset", "Stromsgodset", "Strømsgodset IF"],
    "aalesund": ["Aalesund", "Aalesunds FK"],

    # ======================== POLAND ========================
    "legia-warsaw": ["Legia Warsaw", "Legia Warszawa"],
    "lech-poznan": ["Lech Poznan", "Lech Poznań"],
    "jagiellonia-bialystok": ["Jagiellonia", "Jagiellonia Białystok"],
    "rakow": ["Raków Częstochowa", "Raków", "Rakow"],
    "pogon-szczecin": ["Pogoń Szczecin", "Pogon Szczecin"],
    "slask-wroclaw": ["Śląsk Wrocław", "Slask Wroclaw"],
    "piast-gliwice": ["Piast Gliwice"],
    "gornik-zabrze": ["Górnik Zabrze", "Gornik Zabrze"],
    "cracovia": ["Cracovia", "MKS Cracovia"],
    "wisla-krakow": ["Wisła Kraków", "Wisla Krakow"],
    "widzew-lodz": ["Widzew Łódź", "Widzew Lodz"],
    "zaglebie-lubin": ["Zagłębie Lubin", "Zaglebie Lubin"],
    "korona-kielce": ["Korona Kielce"],
    "warta-poznan": ["Warta Poznań", "Warta Poznan"],
