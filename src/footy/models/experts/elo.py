...
class EloExpert(Expert):
    ...
    ELO_DEFAULT = 1500.0
    K_BASE = 19.0          # v12: optimal K=18.5-19.5 per research
    BLANKET_HOME = 65.0    # v12: post-COVID optimal ~65 (was 40)
    ...
    def compute(self, df: pd.DataFrame) -> ExpertResult:
        ...
        for i, r in enumerate(df.itertuples(index=False)):
            ...
            # F3 fix: Only update rolling state for finished matches (non-NaN goals)
            if _is_finished(r):
