...
DIV_MAP = {
    ...
    "ELC": FDCUKDivision("E1",  "ELC"),   # Championship
    "PPL": FDCUKDivision("P1",  "PPL"),   # Primeira Liga
    "TR1": FDCUKDivision("T1",  "TR1"),   # Turkish Super Lig
    "BEL": FDCUKDivision("B1",  "BEL"),   # Belgian Pro League
    "GR1": FDCUKDivision("G1",  "GR1"),   # Greek Super League
}
