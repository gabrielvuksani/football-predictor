...
@app.command()
def improvement(model: str = "v12_analyst", days: int = 180):
...
@app.command()
def errors(model: str = "v12_analyst", days: int = 180):
...
def compare(*models: str, days: int = 365):
    ...
    if not models:
        ...
        console.print("  Usage: footy perf compare v12_analyst --days 365")
        return
